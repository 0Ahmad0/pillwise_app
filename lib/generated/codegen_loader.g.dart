...
class CodegenLoader extends AssetLoader{
  ...
  "core": {
    ...
    "add": "Add medication",
    "next_intake": "Enter the health symptoms",
    "cancel": "Cancel",
    "arabic": "Arabic",
    "english": "English"
  },
  ...
  "medicationDetails": {
    ...
    "package": "Package",
    "storage": "Storage",
    "legal_status_rx": "Prescription Only",
    "legal_status_otc": "Over The Counter (OTC)",
    "manufacturer_details": "Manufacturer and Origin Details",
    "add_reminder": "Add New Medication",
    "daily": "Daily",
    "weekly": "Weekly",
    "monthly": "Monthly",
  ...
  "admin": {
    "admin_text": "Admin Page",
    "admin_desc": "Please upload an Excel file\nThe file must contain medicine data",
    "upload": "Upload",
    "medicine": "Medicine",
    "copy": "Copy"
  },
  ...
  "logout": "Logout",
  "no_drug_scanned": "No readable medication found",
  "nothing_scanned": "Nothing was scanned",
  "action_required": "Action required",
  "delete_account_confirm": "Are you sure you want to delete your account?",
  "unexpected_error": "An unexpected error occurred. Please try again later.",
  "no_ai_response": "No response received from the automated assistant",
  "ai_connection_error": "An error occurred while connecting to the automated assistant",
  "saved_successfully": "Saved",
  "health_info_saved": "Health information saved successfully",
  "user_name_or_email_already_found": "Username or email already exists",
  "account_created_successfully": "Account created successfully",
  "please_check_all_fields": "Please make sure all fields are filled correctly",
  "user_name_or_email_invalid": "Username or email is invalid",
  "operation_failed_try_again": "Operation failed, please try again",
  "no_data_yet": "No Data Yet!",
  "operation_failed": "Operation failed",
  "operation_success": "Operation succeeded",
  "account_deleted_successfully": "Account deleted successfully",
  "saved_successfully_full": "Saved successfully",
  "medication_deleted_successfully": "Medication successfully deleted",
  "medication_fetched_successfully": "Medication successfully fetched",
  "code_verified_successfully": "Code verified successfully",
  "email_code_sent_successfully": "Email code sent successfully",
  "users_fetched_successfully": "Users successfully fetched",
  "account_logged_successfully": "Account successfully logged",
  "account_not_found": "Account not found",
  "no_user_for_this_email": "No user found for this email.",
  "invalid_user": "Invalid user.",
  "invalid_email": "Invalid email address.",
  "weak_password": "Weak password. It must be at least 6 characters and include uppercase, lowercase, and a special character.",
  "email_already_exists": "This email already exists.",
  "too_many_login_attempts": "You tried to log in too many times. Please try again later.",
  "user_not_activated": "User account is not activated.",
  "entered_email_invalid": "The entered email is invalid.",
  "incorrect_password": "Incorrect password.",
  "no_user_for_this_email_repeat": "No user found for this email.",
  "users_info_fetched_successfully": "Users information fetched successfully"
};
static const Map<String,dynamic> _ar = {
  ...
  "core": {
    ...
    "delete": "إزالة الدواء",
    "add": "إضافة الدواء",
    "next_intake": "كتابة الأعراض الصحية",
    "cancel": "إلغاء",
    "arabic": "العربية",
    "english": "الانجليزية"
  },
  ...
  "medicationDetails": {
    "details": "التفاصيل",
    "manufacturer_country": "بلد المنشأ",
    "manufacturer_name": "الشركة المصنعة",
    "shelf_life": "مدة الصلاحية",
    "form": "الشكل الدوائي",
    "usage": "طريقة الاستخدام",
    "package": "العبوة",
    "storage": "التخزين",
    "legal_status_rx": "وصفة طبية فقط (Rx)",
    "legal_status_otc": "متاح بدون وصفة (OTC)",
    "manufacturer_details": "تفاصيل الشركة المصنعة والمنشأ",
    "add_reminder": "إضافة دواء جديد",
    "daily": "يوميا",
    "weekly": "أسبوعيا",
    "monthly": "شهريا",
  ...
  "admin": {
    "admin_text": "صفحة الآدمن",
    "admin_desc": "قم برفع ملف Excel\n يجب أن يحتوي الملف على بيانات الأدوية",
    "upload": "رفع",
    "medicine": "دواء",
    "copy": "نسخ"
  },
  ...
  "logout": "تسجيل الخروج",
  "no_drug_scanned": "الدواء المقروء غير موجود",
  "nothing_scanned": "لم يتم قراءة أي شيء",
  "action_required": "إجراء مطلوب",
  "delete_account_confirm": "هل أنت متأكد أنك تريد حذف الحساب؟",
  "unexpected_error": "حدث خطأ غير متوقع. يرجى المحاولة مرة أخرى لاحقًا.",
  "no_ai_response": "لم يصل أي رد من المجيب الآلي",
  "ai_connection_error": "حدث خطأ أثناء الاتصال بالمجيب الآلي",
  "saved_successfully": "تم الحفظ",
  "health_info_saved": "تم حفظ المعلومات الصحية بنجاح",
  "user_name_or_email_already_found": "اسم المستخدم أو البريد الإلكتروني موجود مسبقًا",
  "account_created_successfully": "تم إنشاء الحساب بنجاح",
  "please_check_all_fields": "الرجاء التأكد من جميع الحقول المدخلة",
  "user_name_or_email_invalid": "اسم المستخدم أو البريد الإلكتروني غير صالح",
  "operation_failed_try_again": "فشلت العملية، حاول مرة أخرى",
  ...
  "saved_successfully_full": "تم الحفظ بنجاح",
  "medication_deleted_successfully": "تم حذف الدواء بنجاح",
  "medication_fetched_successfully": "تم جلب الدواء بنجاح",
  "code_verified_successfully": "تم التحقق من الرمز",
  "email_code_sent_successfully": "تم إرسال رمز التحقق إلى البريد الإلكتروني",
  "users_fetched_successfully": "تم جلب المستخدمين بنجاح",
  "account_logged_successfully": "تم تسجيل الدخول بنجاح",
  "account_not_found": "الحساب غير موجود",
  "no_user_for_this_email": "لا يوجد مستخدم لهذا البريد الإلكتروني.",
  "invalid_user": "المستخدم غير صحيح.",
  "invalid_email": "البريد الإلكتروني غير صالح.",
  "weak_password": "كلمة المرور ضعيفة، يجب أن تحتوي على 6 محارف على الأقل وتتضمن حرفًا كبيرًا وحرفًا صغيرًا وعلامة ترقيم.",
  "email_already_exists": "هذا البريد موجود مسبقًا.",
  "too_many_login_attempts": "حاولت تسجيل الدخول مرات عديدة، يرجى المحاولة لاحقًا.",
  "user_not_activated": "المستخدم غير مفعل.",
  "entered_email_invalid": "البريد الإلكتروني المُدخل غير صالح.",
  "incorrect_password": "كلمة السر غير صحيحة.",
  "no_user_for_this_email_repeat": "لا يوجد مستخدم لهذا البريد الإلكتروني.",
  "users_info_fetched_successfully": "تم جلب معلومات المستخدمين بنجاح"
};
